...
export function getNewSupplierContractItem(index: any, supplier: Supplier): ChildParentInternal<SupplierContract, Supplier> {
    ...
    let item = {
        ...
        parent_db_item: Object.assign({}, supplier)
    };
